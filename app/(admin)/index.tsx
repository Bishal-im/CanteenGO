...
export default function AdminDashboard() {
  ...
  return (
    <View className="flex-1 bg-background">
      <BlurView intensity={80} tint="dark" className="px-6 pt-16 pb-8 flex-row justify-between items-center border-b border-white/5 z-10">
        <View className="flex-row items-center gap-5">
          <TouchableOpacity 
            onPress={() => router.replace("/")}
            className="w-12 h-12 rounded-2xl bg-white/5 items-center justify-center border border-primary/20 shadow-2xl shadow-primary/5"
          >
        ...
        <TouchableOpacity className="w-14 h-14 rounded-3xl bg-primary/10 items-center justify-center border border-primary/20">
      ...
      <ScrollView className="flex-1 px-4">
        <View className="py-8">
          ...
          {loading ? (
            [1, 2, 3].map((i) => (
              <View key={i} className="mb-4 p-6 bg-white/5 rounded-[32px] gap-4">
